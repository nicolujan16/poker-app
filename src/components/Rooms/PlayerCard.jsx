...
export default function PlayerCard({
	...
	// SetPlayerBet
	useEffect(() => {
		let userFiltered = gameData?.infoUsers?.filter(
	...
	useEffect(() => {
		let gameDataPlayerFilter = gameData?.infoUsers?.filter(
			(infoUser) => infoUser.userUID == player.userUID,
		);
	...
	return (
		<div
			className={
				gameDataPlayer.hasFolded
					? "player-card player-card--folded"
					: "player-card"
			}
		...
		>
			...
			gameData.lastWinner.username == player.username ? (
				<div
					className={
						gameDataPlayer.hasFolded
							? "card-front--container card-front--folded"
			...
			{isAnotherPlayer && (
				<div
					className={
						gameDataPlayer.hasFolded
							? "card-back--container card-back--folded"
							: "card-back--container"
					}
				>
			...
			{/* Admin tag */}
			{player.isAdmin && (
				<div className="admin-tag" title="Administrador de la sala">
					A
				</div>
			)}
		</div>
